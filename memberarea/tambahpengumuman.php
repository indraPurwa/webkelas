...
<form action="memberarea/aksi.php?aksi=tambahpengumuman" method="post" enctype="multipart/form-data">
<table class="table-modul" width="100%" cellspacing="0">
  ...
  <tr>
    ...
    <td align="center">:</td>
    <td><label>
      <textarea name="isi" class="input-textfield" cols="45" rows="5" style="width: 100%;"></textarea>
    </label></td>
  </tr>
  <tr>
    <td colspan="3"><label>
